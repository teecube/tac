...
This branch (*release-trigger-major*) is a [**release trigger branch**](#release-trigger-branch) for the **T³ - TAC** project.
...
To trigger a new release with *major* increment policy, simply [run a new pipeline](https://git.teecu.be/teecube/tac/pipelines/new) after selecting *release-trigger-major* in the list.
That's it !
...
These versions numbers can also be [edited directly in Gitlab](https://git.teecu.be/teecube/tac/edit/release-trigger-major/release.properties).
